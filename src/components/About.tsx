    ...
    <section id="about" className="bg-white py-[70px]">
      <div className="content-wrapper">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[42px] mb-[70px] items-start">
          <div>
            <h3 className="text-brand-dark text-[21px] leading-7 mb-[21px]">
            ...
            <p className="text-brand-muted mb-[21px]">
              ...
              with modern medical equipment and designed with your pet&#39;s
              comfort in mind.
            </p>
            <p className="text-brand-muted mb-[21px]">
            ...
            <div key={feature.title} className="card card-padding text-center">
              <div className="flex flex-col gap-[21px]">
                <div className="flex items-center gap-[10.5px] pt-[21px] pb-3.5 px-[21px]">
                  <div className="flex items-center justify-center h-[42px] w-[42px] rounded-[3.35544e+07px] bg-brand-light">
                    <span className="text-brand-primary">{feature.icon}</span>
                  </div>
                  <h4 className="text-brand-dark text-[15.75px] leading-[24.5px]">
                    {feature.title}
                  </h4>
                </div>
                <div className="pb-[21px] px-[21px]">
                  <p className="text-brand-muted text-[12.25px] leading-[17.5px]">
                    {feature.description}
                  </p>
                </div>
              </div>
        ...
        <div className="text-white bg-[linear-gradient(to_right,theme(colors.brand.primary)_0%,theme(colors.brand.secondary)_100%)] p-[42px] rounded-[14px]">
          <div className="text-center mb-[42px]">
            <h3 className="text-[26.25px] font-medium leading-[31.5px] mb-3.5">
              Brighton Beach Animal Clinic by the Numbers
            </h3>
            <p className="text-brand-light max-w-[588px] mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-7">
            <div className="text-center">
              ...
              <div className="text-brand-light">Newly Opened</div>
            </div>
            <div className="text-center">
              <div className="text-[26.25px] leading-[31.5px] mb-[7px] md:text-[31.5px] md:leading-[35px]">
                100%
              </div>
              <div className="text-brand-light">Caring Staff</div>
            </div>
            <div className="text-center">
              <div className="text-[26.25px] leading-[31.5px] mb-[7px] md:text-[31.5px] md:leading-[35px]">
                Same Day
              </div>
              <div className="text-brand-light">Appointments Available</div>
            </div>
            <div className="text-center">
              <div className="text-[26.25px] leading-[31.5px] mb-[7px] md:text-[31.5px] md:leading-[35px]">
                ∞
              </div>
              <div className="text-brand-light">Love for Pets</div>
            </div>
          </div>
        </div>
      </div>
